      ...
      <div className="relative max-w-7xl mx-auto px-6 md:px-12 text-center">
        ...
        <h1 className="mt-4 text-4xl font-extrabold text-gray-900 dark:text-gray-100 sm:text-5xl lg:text-6xl">
          ...
          <span className="relative inline-block px-2 py-1">
            ...
            <span className="relative">Tailored for You</span>
          </span>
        </h1>

        <p className="mt-6 max-w-3xl mx-auto text-lg text-gray-600 dark:text-gray-300">
          GenLetter AI helps you craft personalized, impactful cover letters in seconds.
          Just paste your resume and job details — we’ll handle the writing.
        </p>

        <div className="flex justify-center items-center gap-4 mt-8 flex-wrap">
          <Link
            href="#"
            className="px-5 py-2 bg-blue-600 dark:bg-blue-500 text-white font-semibold rounded hover:bg-blue-700 dark:hover:bg-blue-600"
          >
            Get Started
          </Link>
